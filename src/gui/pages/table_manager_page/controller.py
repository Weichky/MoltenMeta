...
class DatabaseTableModel(QtCore.QAbstractTableModel):
...
class DatabaseController(QObject):
    ...
    def _onSaveClicked(self) -> None:
        ...
        try:
            ...
            error_title = _translate("DatabaseController", "Error")
            error_msg = _translate("DatabaseController", "Failed to save changes:")
    ...
    def _updateRowCountLabel(self) -> None:
        rows_label = _translate("DatabaseController", "Rows:")
        if self._model:
