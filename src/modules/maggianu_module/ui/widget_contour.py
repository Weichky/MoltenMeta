...
class MaggianuContourWizardDialog(QDialog):
    resultReady = Signal(dict)

    def __init__(self, module_service, user_db_service, parent=None):
        super().__init__(parent)
        self.setWindowTitle(self.tr("Maggianu Contour Configuration"))
    ...
    def _setupUi(self):
        ...
        title = QLabel(self.tr("Maggianu Contour Configuration"))
    ...
    def _onCalculate(self):
        ...
        result = maggianu.calculateContourWithData(
            elemA,
            elemB,
            elemC,
            plane,
