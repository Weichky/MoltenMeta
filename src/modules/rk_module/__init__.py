...
def _createRKSource(module_service):
    return RKDataSource(module_service, "rk_module", "evaluate", "G_E_RK")


def registerDataSources(registry) -> None:
    registry.register("R-K", _createRKSource)
